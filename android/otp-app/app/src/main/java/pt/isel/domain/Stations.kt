...
val trainStations = listOf(
    Station("Cruz Quebrada", "cruz_quebrada_train", TransportType.TRAIN, GeoPoint(38.6997964, -9.2522037)),
    Station("Moscavide", "moscavide_train", TransportType.TRAIN, GeoPoint(38.7776538, -9.0994872)),
    Station("São João do Estoril", "sao_joao_estoril_train", TransportType.TRAIN, GeoPoint(38.7010590, -9.3854678)),
    Station("São Pedro do Estoril", "sao_pedro_estoril_train", TransportType.TRAIN, GeoPoint(38.6953715, -9.3716973)),
    Station("Oeiras", "oeiras_train", TransportType.TRAIN, GeoPoint(38.6884786, -9.3189168)),
    Station("Belém", "belem_train", TransportType.TRAIN, GeoPoint(38.6961785, -9.1974476)),
    Station("Oriente", "oriente_train", TransportType.TRAIN, GeoPoint(38.7678206, -9.0990726)),
    Station("Sete Rios", "sete_rios_train", TransportType.TRAIN, GeoPoint(38.7402397, -9.1666658)),
    Station("Campolide A", "campolide_a_train", TransportType.TRAIN, GeoPoint(38.7315082, -9.1688620)),
    ...
    Station("Cais do Sodré", "cais_do_sodre_train", TransportType.TRAIN, GeoPoint(38.7059788, -9.1457371)),
    Station("Alcântara Mar", "alcantara_mar_train", TransportType.TRAIN, GeoPoint(38.7023549, -9.1740244)),
    Station("Algés", "alges_train", TransportType.TRAIN, GeoPoint(38.6983796, -9.2293871)),
    Station("Carcavelos", "carcavelos_train", TransportType.TRAIN, GeoPoint(38.6878290, -9.3373188)),
    Station("Estoril", "estoril_train", TransportType.TRAIN, GeoPoint(38.7032511, -9.3987253)),
    Station("Cascais", "cascais_train", TransportType.TRAIN, GeoPoint(38.7008746, -9.4179130)),
    Station("Alcântara Terra", "alcantara_terra_train", TransportType.TRAIN, GeoPoint(38.7074106, -9.1732676)),
    ...
    Station("Santa Apolónia", "santa_apolonia_train", TransportType.TRAIN, GeoPoint(38.7146298, -9.1220425)),
    Station("Rossio", "rossio_train", TransportType.TRAIN, GeoPoint(38.7145909, -9.1418412)),
    ...
    Station("Caxias", "caxias_train", TransportType.TRAIN, GeoPoint(38.6987490, -9.2743918)),
    Station("Paço de Arcos", "paco_de_arcos_train", TransportType.TRAIN, GeoPoint(38.6971063, -9.2905353)),
    Station("Santo Amaro", "santo_amaro_train", TransportType.TRAIN, GeoPoint(38.6870328, -9.3125495)),
    Station("Parede", "parede_train", TransportType.TRAIN, GeoPoint(38.6897410, -9.3564015)),
    Station("Monte Estoril", "monte_estoril_train", TransportType.TRAIN, GeoPoint(38.7036008, -9.4064410)),
    ...
    Station("Santos", "santos_train", TransportType.TRAIN, GeoPoint(38.7059962, -9.1551670)),
    Station("Benfica", "benfica_train", TransportType.TRAIN, GeoPoint(38.7443815, -9.1995760)),
    Station("Santa Cruz Damaia", "santa_cruz_damaia_train", TransportType.TRAIN, GeoPoint(38.7470864, -9.2136787)),
    ...
    Station("Agualva Cacém", "agualva_cacem_train", TransportType.TRAIN, GeoPoint(38.7665080, -9.2984297))
)
