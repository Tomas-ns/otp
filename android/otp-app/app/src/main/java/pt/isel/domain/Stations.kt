...
val trainStations = listOf(
    // === LISBOA (partilhadas / centro) ===
    Station("Lisboa - Oriente", "oriente_train", TransportType.TRAIN, GeoPoint(38.7678206, -9.0990726)),
    Station("Braço de Prata", "braco_de_prata_train", TransportType.TRAIN, GeoPoint(38.7470910, -9.1028003)),
    Station("Marvila", "marvila_train", TransportType.TRAIN, GeoPoint(38.7390314, -9.1087569)),
    Station("Roma-Areeiro", "roma_areeiro_train", TransportType.TRAIN, GeoPoint(38.7456858, -9.1355067)),
    Station("Entrecampos", "entrecampos_train", TransportType.TRAIN, GeoPoint(38.7445695, -9.1485925)),
    Station("Sete Rios", "sete_rios_train", TransportType.TRAIN, GeoPoint(38.7402397, -9.1666658)),
    Station("Campolide", "campolide_train", TransportType.TRAIN, GeoPoint(38.7325092, -9.1677396)),
    Station("Alcântara-Terra", "alcantara_terra_train", TransportType.TRAIN, GeoPoint(38.7074080, -9.1732642)),
    Station("Lisboa - Santa Apolónia", "santa_apolonia_train", TransportType.TRAIN, GeoPoint(38.7146298, -9.1220425)),
    Station("Lisboa - Rossio", "rossio_train", TransportType.TRAIN, GeoPoint(38.7145909, -9.1418412)),
    Station("Benfica", "benfica_train", TransportType.TRAIN, GeoPoint(38.7443704, -9.1996207)),

    // === LINHA DE SINTRA ===
    Station("Santa Cruz - Damaia", "santa_cruz_damaia_train", TransportType.TRAIN, GeoPoint(38.7469541, -9.2132290)),
    Station("Reboleira", "reboleira_train", TransportType.TRAIN, GeoPoint(38.7509589, -9.2229560)),
    Station("Amadora", "amadora_train", TransportType.TRAIN, GeoPoint(38.7596796, -9.2357261)),
    Station("Queluz-Belas", "queluz_belas_train", TransportType.TRAIN, GeoPoint(38.7588020, -9.2569673)),
    Station("Monte Abraão", "monte_abraao_train", TransportType.TRAIN, GeoPoint(38.7554581, -9.2654518)),
    Station("Massamá-Barcarena", "massama_barcarena_train", TransportType.TRAIN, GeoPoint(38.7516507, -9.2842005)),
    Station("Agualva-Cacém", "agualva_cacem_train", TransportType.TRAIN, GeoPoint(38.7665168, -9.2984684)),
    Station("Mira Sintra-Meleças", "mira_sintra_melecas_train", TransportType.TRAIN, GeoPoint(38.7895740, -9.3126424)),
    Station("Rio de Mouro", "rio_de_mouro_train", TransportType.TRAIN, GeoPoint(38.7842436, -9.3209670)),
    Station("Mercês", "merces_train", TransportType.TRAIN, GeoPoint(38.7932473, -9.3308054)),
    Station("Algueirão-Mem Martins", "algueirao_mem_martins_train", TransportType.TRAIN, GeoPoint(38.7977041, -9.3411593)),
    Station("Portela de Sintra", "portela_de_sintra_train", TransportType.TRAIN, GeoPoint(38.8022463, -9.3763734)),
    Station("Sintra", "sintra_train", TransportType.TRAIN, GeoPoint(38.7992614, -9.3853576)),

    // === LINHA DA AZAMBUJA ===
    Station("Moscavide", "moscavide_train", TransportType.TRAIN, GeoPoint(38.7776538, -9.0994872)),
    Station("Sacavém", "sacavem_train", TransportType.TRAIN, GeoPoint(38.7949698, -9.0997993)),
    Station("Bobadela", "bobadela_train", TransportType.TRAIN, GeoPoint(38.8068455, -9.0946786)),
    Station("Santa Iria", "santa_iria_train", TransportType.TRAIN, GeoPoint(38.8410385, -9.0801111)),
    Station("Póvoa", "povoa_train", TransportType.TRAIN, GeoPoint(38.8592888, -9.0641982)),
    Station("Alverca", "alverca_train", TransportType.TRAIN, GeoPoint(38.8898802, -9.0341101)),
    Station("Alhandra", "alhandra_train", TransportType.TRAIN, GeoPoint(38.9239341, -9.0114120)),
    Station("Vila Franca de Xira", "vila_franca_xira_train", TransportType.TRAIN, GeoPoint(38.9552993, -8.9862289)),
    Station("Castanheira do Ribatejo", "castanheira_ribatejo_train", TransportType.TRAIN, GeoPoint(38.9890682, -8.9653619)),
    Station("Carregado", "carregado_train", TransportType.TRAIN, GeoPoint(39.0055219, -8.9537297)),

    // === MARGEM SUL (Fertagus) ===
    Station("Pragal", "pragal_train", TransportType.TRAIN, GeoPoint(38.6660449, -9.1798499)),
    Station("Corroios", "corroios_train", TransportType.TRAIN, GeoPoint(38.6364850, -9.1517366)),
    Station("Foros de Amora", "foros_de_amora_train", TransportType.TRAIN, GeoPoint(38.6206292, -9.1288430)),
    Station("Fogueteiro", "fogueteiro_train", TransportType.TRAIN, GeoPoint(38.6098882, -9.1015232)),
    Station("Coina", "coina_train", TransportType.TRAIN, GeoPoint(38.5846486, -9.0515690)),
    Station("Penalva", "penalva_train", TransportType.TRAIN, GeoPoint(38.5900549, -8.9952397)),
    Station("Barreiro", "barreiro_train", TransportType.TRAIN, GeoPoint(38.6529007, -9.0792720)),
    Station("Barreiro-A", "barreiro_a_train", TransportType.TRAIN, GeoPoint(38.6597727, -9.0715778)),
    Station("Lavradio", "lavradio_train", TransportType.TRAIN, GeoPoint(38.6618254, -9.0583124)),
    Station("Baixa da Banheira", "baixa_da_banheira_train", TransportType.TRAIN, GeoPoint(38.6595805, -9.0443375)),
    Station("Alhos Vedros", "alhos_vedros_train", TransportType.TRAIN, GeoPoint(38.6518042, -9.0265383)),
    Station("Moita", "moita_train", TransportType.TRAIN, GeoPoint(38.6446482, -8.9957885)),
    Station("Pinhal Novo", "pinhal_novo_train", TransportType.TRAIN, GeoPoint(38.6301158, -8.9128325)),
    Station("Setúbal", "setubal_train", TransportType.TRAIN, GeoPoint(38.5312029, -8.8845473)),

    // === OUTRAS ===
    Station("Mafra", "mafra_train", TransportType.TRAIN, GeoPoint(38.8974350, -9.2913552)),
    Station("Malveira", "malveira_train", TransportType.TRAIN, GeoPoint(38.9285876, -9.2580076))
)
