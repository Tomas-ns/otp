    ...
    Box(
        ...
        Column(
            ...
            if (!state.isRiding) {
                ...
                val prediction by RideService.currentPrediction.collectAsState()
                val displayText = prediction ?: "Calculating..."

                Text(stringResource(R.string.label_current_occupancy, displayText))
        ...
        if (showStopConfirmation) {
            ConfirmationDialog(
                ...
                onConfirm = {
                    ...
                    onStopService()
                    RideService.currentPrediction.value = null
                },
